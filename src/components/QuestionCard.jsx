...
const QuestionCard = ({ question, onAnswer }) => {
  ...
  return (
    <div className="p-4 rounded shadow max-w-lg mx-auto" style={{ width: 480, minHeight: 420 }}>
      <h3 className="text-lg font-bold mb-4 text-center">{question.question}</h3>
        ...
        {shuffled.map((url, idx) => {
          ...
          if (selectedIndex !== null) {
            if (idx === selectedIndex) {
              borderColor = idx === correctIndex ? "border-green-500" : "border-red-500"
            }
          }
          ...
          return (
            ...
            >
              <img src={url} alt={`Option ${idx}`} className="object-cover" style={{ width: "100%", height: "100%" }} />
            </div>
          )
        })}
      </div>
